...
@RestController
@Api(value="calculateController v1")
...
public class calculateController {
    ...
    public ResponseEntity<Integer> add(
            @ApiParam(value="첫째 값", required=true, example="10")
            @RequestParam(value = "num1", required = true) int num1,
            @ApiParam(value="두번째 값", required=true, example="20")
    ...
    @ApiOperation(value="포스트 테스트", notes="포스트 테스트")
